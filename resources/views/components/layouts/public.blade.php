@php
    $links = [
        [
            'name' => 'Asistencia Administrativos',
            'icon' => 'funnel',
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')">
                    ...
                    <flux:navlist.item icon="funnel" :href="route('asistencia.index')" :current="request()->routeIs('Asistencia.*')" wire:navigate>
                        {{ __('Asistencia Administrativos') }}
                    </flux:navlist.item>
                    @auth
